...
exports.extractEpisodeData = extractEpisodeData;
...
const EXTRACTION_USER_PROMPT = (scriptText) => `
...
${scriptText}
`;
async function extractEpisodeData(scriptText) {
    ...
    console.log(`✅ Extracted: ${parsed.scenes.length} scenes, ${parsed.shots.length} shots — "${parsed.title}"`);
    return parsed;
}
