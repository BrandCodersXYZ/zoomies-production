...
exports.SHOW_CODES = exports.SHOW_DISPLAY_NAMES = exports.SHOW_CODE_MAP = exports.CHARACTERS = void 0;
exports.CHARACTERS = {
    // ── The Real Catwives of Beverly Hills ──────────────────────────────────────
    kitty: {
        name: 'kitty',
        show: 'catwives',
        visualDescription: 'White/cream cat, pristine long-haired coat. Signature white fur coat over form-fitting cream dress. Subtle, controlled facial expressions. Cream and gold color palette throughout.',
        voiceDescription: 'A sophisticated woman in her mid-40s, polished Beverly Hills accent, measured and precise diction, warm but with an edge of steel underneath, speaks at a controlled pace as if every word is chosen intentionally',
    ...
    countess: {
        name: 'countess',
        show: 'catwives',
        visualDescription: 'Dark/near-black sleek cat with sharp, angular features. Structured black evening gowns and tailored ensembles. Signature raised-eyebrow expression. Almost always holding a champagne flute in social settings.',
        voiceDescription: 'A regal European woman in her 50s, aristocratic mid-Atlantic accent with a slight Continental inflection, low and unhurried tone, each word deliberate and sharp, speaks as if mildly disappointed by everything around her',
    ...
    bambi: {
        name: 'bambi',
        show: 'catwives',
        visualDescription: 'Light honey-toned cat with wide, expressive doe eyes. Flowing pink sundress. Soft, slightly rounded features that read as innocent and warm.',
        voiceDescription: 'A warm, sweet young woman in her late 20s, soft Southern California lilt, slightly breathy, wide-eyed and genuine delivery, speaks with open innocent energy — devastating lines land because she sounds like she means them kindly',
    ...
    dominique: {
        name: 'dominique',
        show: 'catwives',
        visualDescription: 'Sleek cat with sharp bone structure and high cheekbones. Always in structured blazers over form-fitting coordinates. Signature pose: arms crossed or actively claiming space.',
        voiceDescription: 'A confident woman in her late 30s, direct and clear American accent, speaks with absolute authority and conviction, owns every word, slightly louder and more commanding than the other women, no uptalk, no hedging',
    ...
    purrlita: {
        name: 'purrlita',
        show: 'catwives',
        visualDescription: 'Bold-colored cat with chaotic energy. Hot pink wardrobe — always bold, always slightly off. Something always slightly askew about her look — a strap falling, wild hair, an accessory out of place.',
        voiceDescription: 'A chaotic woman in her 30s, unpredictable Valley Girl meets unhinged socialite energy, slightly breathless, can shift from loud and declarative to conspiratorial whisper mid-sentence, speech patterns slightly erratic like her thoughts are moving faster than her mouth',
    ...
    chase: {
        name: 'chase',
        show: 'bloodhound',
        visualDescription: 'Classic bloodhound with long droopy ears, deeply wrinkled skin, and brown/tan and black fur. Always wearing a Burberry trench coat. Aviator sunglasses that slide down the snout in dramatic moments.',
        voiceDescription: 'A deep-voiced British man in his late 50s, weary hardboiled detective, gravelly and measured, classic noir monotone delivery, never raises his voice even in crisis, long pauses between observations, sounds perpetually unsurprised',
    ...
    vicki: {
        name: 'vicki',
        show: 'bloodhound',
        visualDescription: 'Scrappy mixed-breed dog with an energetic, slightly scruffy look. Distressed leather jacket with a chewed and battered Bureau badge prominently displayed. More kinetic energy than Chase — always slightly in motion.',
        voiceDescription: 'A scrappy young American woman in her late 20s, speaks fast with bursts of enthusiasm, slightly out of breath energy, cracks of excitement on important words, more chaotic and louder than her partner, tail-wag energy in her voice when something goes right',
    ...
    kibble: {
        name: 'kibble',
        show: 'bloodhound',
        visualDescription: 'Beagle with warm brown/tan/white tri-coloring. White lab coat always present. Thick black-rimmed round glasses. Almost always holding or actively chewing something — a pen, a test tube, a snack.',
        voiceDescription: 'A mild-mannered nerdy man in his mid-30s, slight nasal quality, speaks in rapid excited bursts of scientific information, often trails off mid-thought when distracted by data, occasionally talks while chewing something, coughs and restarts sentences when flustered',
    ...
    vanderpump: {
        name: 'vanderpump',
        show: 'bloodhound',
        visualDescription: 'Impeccably groomed Standard Poodle with platinum/champagne-toned fur. Always holding a glass of milk rosé. Elegant, knowing expression. Warm golden lighting that contrasts sharply with the Bureau cold palette.',
        voiceDescription: 'A refined older woman, smooth mid-Atlantic accent, speaks slowly and deliberately with a hint of amusement, as if she already knows the punchline to everything, slight purring warmth to her tone, never hurried, every pause feels intentional',
