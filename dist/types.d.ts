...
export type SceneFunction = 'setup' | 'confrontation' | 'revelation' | 'cliffhanger' | 'resolution' | 'comedy';
export type ShotAngle = 'wide' | 'medium-two' | 'medium-single' | 'close-up' | 'extreme-close-up' | 'over-shoulder' | 'reaction' | 'insert';
export type ApprovalStatus = 'PENDING' | 'APPROVED' | 'REJECTED';
export type CharacterName = 'kitty' | 'countess' | 'bambi' | 'dominique' | 'purrlita' | 'chase' | 'vicki' | 'kibble' | 'vanderpump';
